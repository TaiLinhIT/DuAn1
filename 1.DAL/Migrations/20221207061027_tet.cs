    ...
    public partial class tet : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "174 Phương Canh", new DateTime(2022, 12, 7, 13, 10, 27, 354, DateTimeKind.Local).AddTicks(5639), "manhman2806@gmail.com", "Bùi Thế Mạnh", 1, null, "NV1", "123", "0379200866", false, true },
                    { 2, "173 Phương Canh", new DateTime(2022, 12, 7, 13, 10, 27, 354, DateTimeKind.Local).AddTicks(5640), "khoanhph18902@gmail.com", "Nguyễn Hữu Khoa", 2, null, "NV2", "123", "0972439693", true, true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 12, 7, 13, 10, 27, 354, DateTimeKind.Local).AddTicks(5583), "", "01", "Bim bim Tôm Cay", "", 5000m, 6000m, 1, true, 10 },
                    { 2, 2, new DateTime(2022, 12, 7, 13, 10, 27, 354, DateTimeKind.Local).AddTicks(5594), "", "02", "Coca Cola", "", 10000m, 12000m, 2, true, 20 },
                    { 3, 3, new DateTime(2022, 12, 7, 13, 10, 27, 354, DateTimeKind.Local).AddTicks(5596), "", "03", "Absolut Vodka", "", 10000m, 60000m, 3, true, 50 },
                    { 4, 4, new DateTime(2022, 12, 7, 13, 10, 27, 354, DateTimeKind.Local).AddTicks(5597), "", "04", "Dầu gội Clear Men", "", 100000m, 150000m, 4, true, 5 }
                });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "CustomerID", "EmployeeID", "Note", "Status", "TotalPrice", "dateCreate" },
                values: new object[] { 1, 1, 1, null, true, 60000m, new DateTime(2022, 12, 7, 13, 10, 27, 354, DateTimeKind.Local).AddTicks(5612) });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "CustomerID", "EmployeeID", "Note", "Status", "TotalPrice", "dateCreate" },
                values: new object[] { 2, 2, 2, null, true, 210000m, new DateTime(2022, 12, 7, 13, 10, 27, 354, DateTimeKind.Local).AddTicks(5613) });
